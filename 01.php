...
//? Primera piedra angular: Abstracción, define atributos y metodos, es decir la forma que van a tener nuestras clases.
...
class Producto {
    // Cuerpo de la clase, aquí podremos insertar atributos o funciones.
...
/*  public $nombre; //* Esto en POO no se le reconoce como variables sino como atributo o propiedades.
    ...
    //* Constructor = Una función que se llama automaticamente se instancie la clase:
                                //Soporta el tipado.
    public function __construct(string $nombre, int $precio, bool $disponible) //Por acá pasamos los datos. __construct se le conoce como metodos magicos en php y este es el mas común. En otros lenguajes el constructor es el mismo nombre de la clase, pero en php es obligatoria esta sintaxis.
    {
        $this->nombre = $nombre; // this se refiere al objeto o la instancia que se ha creeado con el nuevo producto y es una sintaxis especial de php. Se le conoce como función flecha.
        $this->precio = $precio;
